...
Дано объекты-фигуры следующих видов: квадрат, треугольник, круг, трапеция.
 ...
 Также фигуры имеют уникальные методы, например: вернуть радиус,
  длину гипотенузы, длину стороны и т. д.
...
...
Исходный код загрузите на один из сервисов контроля версий (GitHub, Bitbucket). 
Ссылку на репозиторий пришлите на почтовый ящик:  jobs@testmatick.com.
